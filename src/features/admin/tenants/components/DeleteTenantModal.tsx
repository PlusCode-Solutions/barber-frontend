...
import type { Tenant } from "../api/tenants.service";
...
export default function DeleteTenantModal({ open, tenant, submitting = false, onConfirm, onClose }: Props) {
            ...
            <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl">
                ...
                <div className="space-y-4 px-6 py-5">
                    <div className="flex items-start gap-3 rounded-xl bg-red-50 px-4 py-3 text-red-700">
                        ...
                        <div>
                            <p className="font-semibold">¿Seguro que deseas eliminar este tenant?</p>
                            <p className="text-sm text-red-600/80">
                                {tenant.name} · {tenant.slug}
                            </p>
                            <p className="mt-2 text-xs text-red-500">Se eliminarán todos los usuarios y datos asociados.</p>
                        </div>
                    </div>
