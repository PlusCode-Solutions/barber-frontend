    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
        <div className="bg-white p-6 rounded-2xl shadow-lg text-center w-full max-w-sm">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-3">Barbería no encontrada</h2>
      ...
      <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-xl w-full max-w-sm border border-gray-100">
        {tenant.logoUrl && (
          <div className="flex justify-center mb-8">
            <img src={tenant.logoUrl} className="h-16 sm:h-20 object-contain" />
          </div>
        )}

        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">Bienvenido</h1>
          <p className="text-xl font-semibold" style={{ color: tenant.primaryColor ?? "#6366f1" }}>
            {tenant.name}
          </p>
        </div>
